...
export const ImportCard = ({ data, onCancel, onSubmit }: ImportCardProps) => {
  ...
  const progress = Object.values(selectedColumns).filter((value) => 
    value && requiredOptions.includes(value)
  ).length;
  ...
  const handleContinue = () => {
    ...
    const formattedData = arrayOfData.map((item) => {
      ...
      return {
        ...item,
        amount: convertAmountToMilliunits(validatedAmount),
